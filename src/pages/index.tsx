...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Gamers Studio Test App`}</title>

        <meta
          name="description"
          content="Experience the ultimate gaming marketplace with Gamers Studio Test App - Bridging B2B and B2C interactions seamlessly."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1532079563951-0c8a7dacddb3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxtYXJrZXRwbGFjZXxlbnwwfHx8fDE2OTA5MTE0NjZ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Gamers Studio Test App`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the ultimate gaming marketplace with Gamers Studio Test App - Bridging B2B and B2C interactions seamlessly.`}
            </Text>
            <Box
